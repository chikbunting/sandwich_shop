      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            const SizedBox(height: 8),
            // Show total price for current selection
            Text(
              'Total price: £${_pricingRepository.totalFor(quantity: _orderRepository.quantity, isFootlong: _isFootlong).toStringAsFixed(2)}',
              style: normalText,
            ),
